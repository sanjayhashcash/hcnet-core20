...
class OverlayManager
{
  public:
    ...
    static bool isFloodMessage(HcnetMessage const& msg);
    ...
    virtual bool
    broadcastMessage(std::shared_ptr<HcnetMessage const> msg,
    ...
    virtual void recvTransaction(HcnetMessage const& msg,
                                 Peer::pointer peer) = 0;
