...
bool
OverlayManager::isFloodMessage(HcnetMessage const& msg)
{
...
void
OverlayManagerImpl::recvTransaction(HcnetMessage const& msg,
                                    Peer::pointer peer)
{
    ZoneScoped;
...
bool
OverlayManagerImpl::broadcastMessage(std::shared_ptr<HcnetMessage const> msg,
