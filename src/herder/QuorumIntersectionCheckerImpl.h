...
class MinQuorumEnumerator
{
    ...
    size_t
    pickSplitNode(hcnet::hcnet_default_random_engine& randEngine) const;
...
class QuorumIntersectionCheckerImpl : public hcnet::QuorumIntersectionChecker
{
    ...
    mutable hcnet::hcnet_default_random_engine mRand;
  ...
  public:
    QuorumIntersectionCheckerImpl(
        ...
        hcnet::hcnet_default_random_engine::result_type seed,
        bool quiet = false);
