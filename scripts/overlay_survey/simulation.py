"""
This module simulates the HTTP endpoints of hcnet-core's overlay survey
"""
...
class SurveySimulation:
    """
    Simulates the HTTP endpoints of hcnet-core's overlay survey. Raises
    ...
    def _getsurveyresult(self, params):
        ...
        while self._pending_requests:
            ...
            # Remove "version" field, which is not part of hcnet-core's
            # response
